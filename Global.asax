...
<script runat="server">
    ...
    void Application_Start(object sender, EventArgs e) 
    {
        ...
        plus._System.Configuration.Manager.Set(plus._System.Configuration.ConfigurationElement.BASE_URL, "http://localhost/");
        plus._System.Configuration.Manager.Set(plus._System.Configuration.ConfigurationElement.SECURITY_PATH, "http://localhost/Exam/");
