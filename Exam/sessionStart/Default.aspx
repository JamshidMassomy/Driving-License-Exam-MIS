...
<div class="d-flex justify-content-center mt-3 mb-3">
 <ul class="pagination shadow-1" runat="server" ID="Q_counter">
    ...
    <li  id="tab2"  class="page-item" ><a href="#" class="page-link page-link-white legitRipple">2</a></li>
     ...
     <li id="tab9" class="page-item" ><a href="#" class="page-link page-link-white legitRipple">9</a></li>
     <li id="tab10" class="page-item" ><a href="#" class="page-link page-link-white legitRipple">10</a></li>
     <li id="tab11" class="page-item"><a href="#" class="page-link page-link-white legitRipple">
...
<script type="text/javascript">
    ...
    (function () {
        if (localStorage.getItem('active') >= 10) {
