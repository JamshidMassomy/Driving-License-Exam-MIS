...
<script runat="server">
    ...
    void Application_Start(object sender, EventArgs e) 
    {
        ...
        plus._System.Configuration.Manager.Set(plus._System.Configuration.ConfigurationElement.BASE_URL, "http://192.168.2.198/Exam/");
        plus._System.Configuration.Manager.Set(plus._System.Configuration.ConfigurationElement.SECURITY_PATH, "http://192.168.2.198/security/");
